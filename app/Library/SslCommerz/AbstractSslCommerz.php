...
abstract class AbstractSslCommerz implements SslCommerzInterface
{
    ...
    public function callToApi($data, $header = [], $setLocalhost = false)
    {
        ...
        $data['success_url'] = 'https://collegeadmission.sems.ac/success';
        $data['fail_url'] = 'https://collegeadmission.sems.ac/fail';
        $data['cancel_url'] = 'https://collegeadmission.sems.ac/cancel';
        $data['ipn_url'] = 'https://collegeadmission.sems.ac/ipn';
