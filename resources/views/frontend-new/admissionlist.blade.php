                    ...
                    <div class="container spaceb50">
                        <div class="row">
                            ...
                            <div class="refine-categ-header " style="margin-top: 10px;">
                                ...
                                <h3 style="text-align: center;font-weight: bold">Online Admission KG (2025) (অনলাইন ভর্তি)
                                </h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h5 class="modal-title " style="font-weight: bold;width: 98%;"><span style="color: #20aee5">বিএএফ শাহীন
                            কলেজ ঢাকা</span> <br /> <span style="color: red">(শিক্ষাবর্ষ ২০২৫ কেজি শ্রেণির
                            ভর্তি)</span><br /> <span style="color: rgb(46,49,146)" id="versiontext"></span></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('admissionstore') }}" method="post" enctype="multipart/form-data" class="onlineform"
                    id="checkstatusform">
                    <div class="modal-body">
