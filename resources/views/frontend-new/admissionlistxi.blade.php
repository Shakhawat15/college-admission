...
@section('content')
    ...
    <div class="container my-4 notice">
                ...
                <div class="card">
                    <div class="grid-table">
                        <div class="grid-item"><span class="row-label">SL</span> <span
                                class="row-value">{{ $key + 1 }}</span></div>
                        <div class="grid-item"><span class="row-label">Class</span> <span
                                class="row-value">{{ $admission->class->class_name }}</span></div>

                        <div class="grid-item"><span class="row-label">Version</span> <span
                                class="row-value">{{ $admission->version->version_name }}</span></div>
                        <div class="grid-item"><span class="row-label">Session</span>
                            <span
                                class="row-value">{{ $admission->class->class_code == 11 ? $session->session_name . '-' . ((int) $session->session_name + 1) : $admission->session->session_name }}</span>
                        </div>

                        <div class="grid-item"><span class="row-label">Start Date</span> <span
                                class="row-value">{{ $admission->start_date }}</span></div>
        ...
        <div class="text-center mt-3">
            <a class="onlineformbtn" href="{{ route('login') }}">Already Registered? Click Here</a>
        </div>
    </div>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control" id="full_name" name="full_name"
                                    value="{{ old('full_name') }}" readonly required>
                            </div>
                            <div class="col-md-6 col-12">
                                <label>Group (বিভাগ)<span style="color:red">*</span></label>
                                <input type="text" class="form-control" id="group_name" name="group_name"
                                    value="{{ old('group_name') }}" readonly required>
                            </div>
                        </div>
                    </div>
