...
use App\Http\Controllers\AttendanceReconcilationController;
...
use App\Http\Controllers\AssetAndInventoryController;
use App\Http\Controllers\CategoryWiseLeaveBalanceController;
use App\Http\Controllers\DisciplinaryIssuesController;
use App\Http\Controllers\DocumentController;
use App\Http\Controllers\EFileController;
use App\Http\Controllers\ELibraryController;
use App\Http\Controllers\SendMailController;
use App\Http\Controllers\Registration\TestimonialController;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\Route;
use SebastianBergmann\CodeCoverage\Report\Html\Dashboard;
use App\Http\Controllers\ReconcilationDateController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('/student-active/{id}', [StudentController::class, 'studentActive'])->name('studentActive');
    Route::get('/student-inactive-list', [StudentController::class, 'studentInactiveList'])->name('studentInactiveList');
    ...
    Route::get('/studentPIDUpload', [StudentController::class, 'studentPIDUpload'])->name('studentPIDUpload');
    Route::get('/studentXlUpload', [StudentController::class, 'studentXlUpload'])->name('studentXlUpload');
    Route::get('/studentBasicInfoXlUpload', [StudentController::class, 'studentBasicInfoXlUpload'])->name('studentBasicInfoXlUpload');
    Route::get('/studentSubjectXlUpload', [StudentController::class, 'studentSubjectXlUpload'])->name('studentSubjectXlUpload');
    ...
    Route::post('/studentPIDUploadSave', [StudentController::class, 'studentPIDUploadSave'])->name('studentPIDUploadSave');
    ...
    Route::post('/get-attendance-by-month', [AttendanceController::class, 'getAttendanceByMonth'])->name('getAttendanceByMonth');
